...
<head>
    ...
    <title>Album - Sourcecode.lk</title>
...
<body class="page-body">
        ...
        <div class="main-content">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">Manage Album</h3>
                                ...
                                ?>
                                    <div class="col-md-3 col-sm-4 col-xs-6" style="margin-bottom: 10px;" id="div<?php echo $album['id'] ?>">
                                        <div class="album-image">
                                            <a href="#">
                                                <img src="../upload/album/<?php echo $album['image_name'] ?>" class="img-responsive" />
                                            </a>

                                            <h6 href="#" class="name">
                                                <em><?php echo $album['title'] ?></em>
                                            </h6>

                                            <div class="image-options">
                                                <a href="edit-album.php?id=<?php echo $album['id'] ?>" style="color:white; padding: 4px;background-color: blue;border-radius: 2px; "><i class="fa-pencil"></i></a> |
                                                <a href="create-album-photo.php?id=<?php echo $album['id'] ?>" style="color:white; padding: 4px;background-color: green;border-radius: 2px; "><i class="fa-image"></i></a> |
                                                <a href="#" class="delete-album" data-id="<?php echo $album['id'] ?>" style="color:white; padding: 4px;background-color: red;border-radius: 2px; "><i class="fa-trash"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
    ...
    <script src="delete/js/album.js"></script>
</body>
